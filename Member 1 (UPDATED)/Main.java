...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            // Two callbacks:
            // 1. onAllComplete — fires when all 10 topics are done (shows a message)
            // 2. onGoToQuiz   — fires when user clicks "Take the Quiz" button on any topic
            LearningModulePanel learningPanel = new LearningModulePanel(
                ...
                () -> {
                    // "Take the Quiz" button clicked on any topic page
                    mainLayout.show(mainContainer, "QUIZ");
                }
            );
